...
<div>
  <AutoLightboxImage
    src={`${IMAGE_DIR}/n52-head-2.webp`}
    largeSrc={`${IMAGE_DIR}/original/n52-head-2.webp`}
...
<div>
  <AutoLightboxImage
    src={`${IMAGE_DIR}/n52-deck-1.webp`}
    largeSrc={`${IMAGE_DIR}/original/n52-deck-1.webp`}
...
<div>
  <AutoLightboxImage
    src={`${IMAGE_DIR}/n52-deck-cylinder-1.webp`}
    largeSrc={`${IMAGE_DIR}/original/n52-deck-cylinder-1.webp`}
...
<div>
    <AutoLightboxImage
      src={`${IMAGE_DIR}/n52-valve-close-up.webp`}
      largeSrc={`${IMAGE_DIR}/original/n52-valve-close-up.webp`}
