...
- No cracks
- Poured brake cleaner down the ports to do a basic leak-down test—that shit poured right out
- Removed the valves from the head
- The valve seats had **zero exposed metal whatsoever**
- Same goes for the valves

But holy shit, those valves looked bad.
...
<Masonry columns={2}>
  <div>
    <LightboxImage
      src='/images/mysterious-n52-carbon-valves/n52-valve-carbon.jpg'
  ...
  <div>
    <LightboxImage
      src='/images/mysterious-n52-carbon-valves/n55-valve-carbon.jpg'
...
Here's a comprehensive look at the teardown process and findings. The photos tell the story of one of the most unusual engine failures I've documented.

<Masonry columns={3} gap='1.5rem'>
  <div>
    <LightboxImage
      src='/images/mysterious-n52-carbon-valves/n52-head-1.jpg'
      alt='BMW E83 N52 engine bay'
    />
    <div
      style={{
        marginTop: '0.5rem',
    ...
    >
      The E83 engine bay - tight quarters for major work
    </div>
  </div>

<div>
  <LightboxImage
    src='/images/mysterious-n52-carbon-valves/n52-head-2.jpg'
    alt='Cylinder head removal process'
  />
  <div
    style={{
      marginTop: '0.5rem',
  ...
  >
    Head removal - note the broken bolt complicating the process
  </div>
</div>

<div>
  <LightboxImage
    src='/images/mysterious-n52-carbon-valves/n52-deck-cylinder-1.jpg'
    alt='Intact head gasket'
  />
  <div
    style={{
      marginTop: '0.5rem',
  ...
  >
    The shocking discovery - completely intact head gasket
  </div>
</div>

<div>
  <LightboxImage
    src='/images/mysterious-n52-carbon-valves/n52-deck-1.jpg'
    alt='Carbon buildup on valve seat #1'
  />
  <div
    style={{
      marginTop: '0.5rem',
  ...
  >
    Top view of deck - note the starter in the top right I keep thinking is a
    coke bottle
  </div>
</div>
</Masonry>

**Still can't explain it.** If you've seen anything like this before or have theories about how valve seats can completely seal themselves with carbon while maintaining zero compression, I'd love to hear from you.
